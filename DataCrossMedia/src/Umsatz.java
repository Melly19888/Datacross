...
public class Umsatz {
	...
	private void calculate(String o) {
		
		int ziel = 0;
		int post =0; 
		int aufschlagWolle = 0;
		int aufschlagBuero = 0;
		int aufschlagKurware = 0;
		int anteilWolle = 0;
		int anteilKurzware = 0;
		int anteilBuero = 0;
		int Rest = 0;
		

		ziel = Integer.parseInt(Zieleingabe.getText());
		post = Integer.parseInt(Post_Eingabe.getText());
		aufschlagWolle = Integer.parseInt(Aufschlag_Wolle.getText());
		aufschlagBuero = Integer.parseInt(Aufschlag_Büro.getText());
		aufschlagKurware = Integer.parseInt(Aufschlag_Kurzware.getText());
		anteilWolle = Integer.parseInt(Anteile_Wolle.getText());
		anteilKurzware = Integer.parseInt(Anteile_Kurzware.getText());
		anteilBuero = Integer.parseInt(Anteile_Büro.getText());
